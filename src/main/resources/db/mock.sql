...
INSERT INTO "app_user" (username, password, email)
VALUES ('user1', '$2a$10$fn/K6upEvwqz9ndoGgEVr.kjL0TsDsX4qvJmYNvvDg1Cgf34dR.LS', 'user1@example.com'),
...
FROM "app_user" u,
     roles r
WHERE r.authority = 'USER'
  AND u.username IN ('user1', 'user2', 'user3', 'user4', 'user5');
...
VALUES ('Landscape Contest', 'LANDSCAPE',
        (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(),
        now(), now() + interval '10 minutes'),
       ('Portrait Contest', 'PORTRAIT',
        (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(),
        now(), now() + interval '10 minutes');
...
-- Insert admin as jury for all contests and as the organizer
-- Step 1: Insert two contests organized by admin
-- Step 1: Insert six contests (3 Landscape and 3 Portrait)
INSERT INTO contest (title, category, organizer_id, created_at, updated_at, start_date, submission_end_date, end_date)
VALUES
-- Landscape Contests
('Landscape Contest 1', 'LANDSCAPE',
 (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(),
 now(), now() + interval '1 hour', now() + interval '2 hour'),
('Landscape Contest 2', 'LANDSCAPE',
 (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(),
 now(), now() + interval '1 hour', now() + interval '2 hour'),
('Landscape Contest 3', 'LANDSCAPE',
 (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(),
 now(), now() + interval '1 hour', now() + interval '2 hour'),

-- Portrait Contests
('Portrait Contest 1', 'PORTRAIT',
 (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(),
 now(), now() + interval '1 hour', now() + interval '2 hour'),
('Portrait Contest 2', 'PORTRAIT',
 (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(),
 now(), now() + interval '1 hour', now() + interval '2 hour'),
('Portrait Contest 3', 'PORTRAIT',
 (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(),
 now(), now() + interval '1 hour', now() + interval '2 hour');

-- Step 2: Insert phases for each contest (Phase 1 ends in 3 minutes, Phase 2 in 5 minutes)

-- Phases for Landscape Contests
INSERT INTO phase (contest_id, start_date_time, end_date_time, type, is_concluded)
SELECT c.id, now(), now() + interval '1 hour', 'PHASE_ONE', FALSE
FROM contest c
WHERE c.title LIKE 'Landscape Contest%';
...
-- Phases for Portrait Contests
INSERT INTO phase (contest_id, start_date_time, end_date_time, type, is_concluded)
SELECT c.id, now(), now() + interval '1 hour', 'PHASE_ONE', FALSE
FROM contest c
WHERE c.title LIKE 'Portrait Contest%';
...
SELECT FALSE,
       ...
       p.id,
       'Great job, you share first place!'
...
SELECT FALSE,
       ...
       (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')),
       p.id,
       'Amazing, you lead with more than double the score!'
FROM photo_submission p
...
INSERT INTO contest (title, category, organizer_id, created_at, updated_at, start_date, submission_end_date, end_date)
VALUES
    ('Portrait Contest 4', 'PORTRAIT', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Portrait Contest 5', 'PORTRAIT', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Portrait Contest 6', 'PORTRAIT', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Portrait Contest 7', 'PORTRAIT', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Portrait Contest 8', 'PORTRAIT', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Portrait Contest 9', 'PORTRAIT', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Portrait Contest 10', 'PORTRAIT', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Portrait Contest 11', 'PORTRAIT', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Portrait Contest 12', 'PORTRAIT', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Portrait Contest 13', 'PORTRAIT', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour');

-- Insert 10 Street Dummy Contests
INSERT INTO contest (title, category, organizer_id, created_at, updated_at, start_date, submission_end_date, end_date)
VALUES
    ('Street Contest 1', 'STREET', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Street Contest 2', 'STREET', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Street Contest 3', 'STREET', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Street Contest 4', 'STREET', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Street Contest 5', 'STREET', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Street Contest 6', 'STREET', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Street Contest 7', 'STREET', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Street Contest 8', 'STREET', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Street Contest 9', 'STREET', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour'),
    ('Street Contest 10', 'STREET', (SELECT id FROM user_profile WHERE id = (SELECT id FROM app_user WHERE username = 'admin')), now(), now(), now(), now() + interval '1 hour', now() + interval '2 hour');

-- Insert phases for Landscape Contests (4 to 13)
INSERT INTO phase (contest_id, start_date_time, end_date_time, type, is_concluded)
SELECT c.id, now(), now() + interval '1 hour', 'PHASE_ONE', FALSE
FROM contest c
WHERE c.title LIKE 'Landscape Contest%';
...
-- Insert phases for Portrait Contests (4 to 13)
INSERT INTO phase (contest_id, start_date_time, end_date_time, type, is_concluded)
SELECT c.id, now(), now() + interval '1 hour', 'PHASE_ONE', FALSE
FROM contest c
WHERE c.title LIKE 'Portrait Contest%';
...
-- Insert phases for Street Contests (1 to 10)
INSERT INTO phase (contest_id, start_date_time, end_date_time, type, is_concluded)
SELECT c.id, now(), now() + interval '1 hour', 'PHASE_ONE', FALSE
FROM contest c
